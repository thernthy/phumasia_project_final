...
$converdTor = 1000;
// Display lot Type
$getLotType = "SELECT Lot_type, COUNT(*) as count FROM cashew_record WHERE task = 'Packing'
...
$expendingbroken = 0;
$expendingbrown = 0;
$get_expend_data = "SELECT SUM(good) as extotalgood, SUM(broken) as extotalbroken, SUM(brown) as extotalbrown
FROM expend WHERE MONTH(date) = MONTH(CURDATE())";
$view_expend_data = mysqli_query($conn, $get_expend_data);
if(!$view_expend_data){
    echo "Error: " . mysqli_error($conn);
}else{
    while($row = mysqli_fetch_assoc($view_expend_data)){
        $expendingGood = $row['extotalgood'];
        $expendingbroken = $row['extotalbroken'];
        $expendingbrown = $row['extotalbrown'];
    }
}
...
FROM cashew_record 
WHERE task = 'Packing' AND MONTH(date) = MONTH(CURDATE())";
...
<div class="col-xl-3 col-md-6">
    ...
    <div class="card bg-success text-white mb-4">
        <div class="card-body">
            ...
            echo ($sttotalGood/$converdTor) - ($expendingGood/$converdTor);
echo ' Kg </span>
        </div>
...
<div class="col-xl-3 col-md-6">
    ...
    <div class="card bg-warning text-white mb-4">
        <div class="card-body">
         Broken: <span id="totalBroken">'; 
         echo ($sttotalBroken/$converdTor) - ($expendingbroken/$converdTor);
         echo' Kg</span>
        </div>
        <div class="card-footer d-flex align-items-center justify-content-between">
        <span id="lotTypeValue">';
...
<div class="col-xl-3 col-md-6">
    ...
    <div class="card bg-danger text-white mb-4">
        <div class="card-body">
         Brown: <span id="totalBrown">';
          echo ($sttotalBrown/$converdTor) - ($sttotalBrown/$converdTor); 
          echo' Kg </span>
        </div>
        <div class="card-footer d-flex align-items-center justify-content-between">
        <span id="lotTypeValue">';
    ...
    <i class="fas fa-table me-1"></i>
     ...
     <div class="card-body">
        <table id="datatablesSimple">
            ...
            <tbody>';
            $get_oven_data = "SELECT date, Name, place, Lot_type, Good, Broken, Brown FROM cashew_record 
            WHERE task='Packing' AND MONTH(date) = MONTH(CURDATE())
             ORDER BY date DESC";
