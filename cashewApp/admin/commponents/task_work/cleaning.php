...
$converdTor = 1000;
// Display lot Type
$getLotType = "SELECT Lot_type, COUNT(*) as count FROM cashew_record WHERE task = 'Cleaning'
...
FROM cashew_record 
WHERE task = 'Cleaning' AND YEAR(date) = YEAR(CURDATE()) AND MONTH(date) = MONTH(CURDATE())";
    ...
    <i class="fas fa-table me-1"></i>
     ...
     <div class="card-body">
        <table id="datatablesSimple">
            ...
            <tbody>';
            $get_oven_data = "SELECT date, Name, place, Lot_type, Good, Broken, Brown FROM cashew_record WHERE task='Cleaning' ORDER BY date DESC";
