...
<div class="egg_record_con">
    ...
    <div class="row mt-4 mb-4">
        <label for="bar_code_id" class="col-sm-4 col-form-label">ជ្រើរើស​ លេខសម្គាល់</label>
        <div class="col">
...
document.getElementById('chicken_born').addEventListener('submit', function(event) {
    ...
    xhr.open('POST', 'http://localhost/Green_famer_project/user/routing/get_chiken_born_record_req.php', true);
    xhr.onload = function() {
        if (xhr.status === 200) {
