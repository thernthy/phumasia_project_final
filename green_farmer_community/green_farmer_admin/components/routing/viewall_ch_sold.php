                ...
                echo'<div class="data_row">
                    ...
                    <h5>
                     ...
                     <h5>
                        ...
                        <span>'.number_format($b_ch_price).' ៛</span>
                     </h5>
                     <h5>
                        <span style="font-size:'.$font_size.'">តម្លៃសរុប</span><br>
                        <span>'.number_format($b_ch_sold_total_price).' ៛</span>
                    </h5>
                    <h5>
                     ...
                     <h5>
                        ...
                        <span>'.(($b_ch_cmr_name!='')?$b_ch_cmr_name:'<span style="color:red; font-size:'.$font_size.';">មិនមានឈ្មោះ</span>').'</span>
                     </h5>
                     <h5>
                        <span style="font-size:'.$font_size.'">អាសយដ្ឋានអតិថិជន</span><br>
                        <span>'.(($b_ch_cmr_ad!='')?$b_ch_cmr_ad:'<span style="color:red; font-size:'.$font_size.';">មិនមានទីតាំង</span>').'</span>
                     </h5>
                     <h5>
                        <span style="font-size:'.$font_size.'">ទំនាក់ទំនងអតិថិជន</span><br>
                        <span>'.(($b_ch_cmr_ad!='')?$b_ch_cmr_ad:'<span style="color:red; font-size:'.$font_size.';">គ្មានលេខទំនាកទំនង</span>').'</span>
                     </h5>
                 </div>';
                $sold_out_checking ++;
            }
